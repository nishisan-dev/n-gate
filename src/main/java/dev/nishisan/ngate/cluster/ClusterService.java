...
/**
 * Gerencia o ciclo de vida do NGridNode embarcado no n-gate.
 * <p>
...
public class ClusterService {
    ...
    private static String resolveNodeId(String configured) {
        ...
        String envId = System.getenv("NGATE_CLUSTER_NODE_ID");
        ...
        try {
            ...
            return "ngate-" + UUID.randomUUID().toString().substring(0, 8);
        }
    }
}
